...
- Implementado: interfaz 2.0 de dos pantallas principales sin scroll vertical, escaneo automático con radar animado, transición fluida al Resumen, telemetría compacta y acceso a celdas, histórico, gráficos, diagnóstico e información desde el menú de tres puntos.
...
- Implementado: página de Gráficos con tendencias de voltaje, temperatura, potencia y SOC leídas del histórico en SQLite, filtros de 1 h/24 h/7 d/todo y una tarjeta de balance de celdas. El rango se consulta con un tope de muestras: cuando lo alcanza, el pie de la página avisa de que la vista es parcial en lugar de recortar en silencio.
...
- Validado automáticamente: solución Android completa sin advertencias en `Debug` y `Release`, y 45 pruebas unitarias.
